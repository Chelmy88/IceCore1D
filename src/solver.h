...
void spin_up(const model_functions * const functions, const model_parameters * const params, double *temperature, double thick, double tsurf,double acc, double QG, double mw,double* tborder, double deltaH,int border,double len, double flat, double* melt, double *density);
//Perform the spin_up of the model for the given time using the CN scheme

void t_solve(const model_functions * const functions, const model_parameters * const params, double *temperature, int time, double thickness, double thicknessFuture, double tsurf,double acc,double* melt, double QG, double mw, double* tborder,double deltaH, int border,double len, double flat, double* freeze, double *density);
